...
public aspect TestNameAspect {
    ...
    pointcut junit3TestExec() : execution(* test*(..)) && within(junit.framework.TestCase+) && !adviceexecution() && BaseAspect.notwithin();
