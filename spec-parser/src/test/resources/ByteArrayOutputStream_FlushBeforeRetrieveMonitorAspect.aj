...
public aspect ByteArrayOutputStream_FlushBeforeRetrieveMonitorAspect implements com.runtimeverification.rvmonitor.java.rt.RVMObject {
	...
	before (ByteArrayOutputStream b) : ByteArrayOutputStream_FlushBeforeRetrieve_tostring(b) {
		ByteArrayOutputStream_FlushBeforeRetrieveRuntimeMonitor.ByteArrayOutputStream_FlushBeforeRetrieve_tostringEvent(thisJoinPointStaticPart, b);
	}
	...
	before (ByteArrayOutputStream b) : ByteArrayOutputStream_FlushBeforeRetrieve_tobytearray(b) {
		ByteArrayOutputStream_FlushBeforeRetrieveRuntimeMonitor.ByteArrayOutputStream_FlushBeforeRetrieve_tobytearrayEvent(thisJoinPointStaticPart, b);
	}
	...
	before (OutputStream o) : ByteArrayOutputStream_FlushBeforeRetrieve_close(o) {
		ByteArrayOutputStream_FlushBeforeRetrieveRuntimeMonitor.ByteArrayOutputStream_FlushBeforeRetrieve_closeEvent(thisJoinPointStaticPart, o);
	}
	...
	before (OutputStream o) : ByteArrayOutputStream_FlushBeforeRetrieve_flush(o) {
		ByteArrayOutputStream_FlushBeforeRetrieveRuntimeMonitor.ByteArrayOutputStream_FlushBeforeRetrieve_flushEvent(thisJoinPointStaticPart, o);
	}
	...
	before (OutputStream o) : ByteArrayOutputStream_FlushBeforeRetrieve_write(o) {
		ByteArrayOutputStream_FlushBeforeRetrieveRuntimeMonitor.ByteArrayOutputStream_FlushBeforeRetrieve_writeEvent(thisJoinPointStaticPart, o);
	}
	...
	after (ByteArrayOutputStream b) returning (OutputStream o) : ByteArrayOutputStream_FlushBeforeRetrieve_outputstreaminit(b) {
		ByteArrayOutputStream_FlushBeforeRetrieveRuntimeMonitor.ByteArrayOutputStream_FlushBeforeRetrieve_outputstreaminitEvent(thisJoinPointStaticPart, b, o);
	}
